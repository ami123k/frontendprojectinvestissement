...
@Component({
  selector: 'app-afficherproposition-nonconfirme',
  templateUrl: './afficherproposition-nonconfirme.component.html',
  styleUrls: ['./afficherproposition-nonconfirme.component.css']
})
export class AfficherpropositionNonconfirmeComponent implements OnInit {
...
this.url = this.tokenStorageService.getUser().id;
    this.propositionservice.getproposition(this.url, 'GetAllPropositionNonconfirm/').subscribe(e => {
      this.propositions = e;
